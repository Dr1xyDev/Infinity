...
use pocketmine\level\generator\normal\biome\HillsBiome;
use pocketmine\level\generator\normal\biome\RoofedForestBiome;
use pocketmine\level\generator\normal\biome\SmallMountainsBiome;
use pocketmine\level\generator\normal\biome\TaigaBiome;
use pocketmine\level\generator\normal\biome\OakPlainsBiome;
use pocketmine\level\generator\normal\biome\JunglePlainsBiome;
use pocketmine\level\generator\normal\biome\TaigaPlainsBiome;
use pocketmine\level\generator\normal\biome\DesertPlainsBiome;
use pocketmine\level\generator\normal\biome\RoofedPlainsBiome;
use pocketmine\level\generator\normal\biome\SnowPlainsBiome;
use pocketmine\level\generator\normal\biome\BirchPlainsBiome;
...
abstract class Biome{
        ...
        const SAVANNA = 35;
        const HIGH_SAVANNA = 36;
        const HILLS = 37;

        const ROOFED_FOREST = 29;

        const OAK_PLAINS     = 40;
        const JUNGLE_PLAINS  = 41;
        const TAIGA_PLAINS   = 42;
        const DESERT_PLAINS  = 43;
        const ROOFED_PLAINS  = 44;
        const SNOW_PLAINS    = 45;
        const BIRCH_PLAINS   = 46;
        ...
        public static function init(){
                ...
                self::register(self::HIGH_SAVANNA, new HighSavannaBiome());
                self::register(self::ROOFED_FOREST, new RoofedForestBiome());
                self::register(self::HILLS, new HillsBiome());

                self::register(self::OAK_PLAINS, new OakPlainsBiome());
                self::register(self::JUNGLE_PLAINS, new JunglePlainsBiome());
                self::register(self::TAIGA_PLAINS, new TaigaPlainsBiome());
                self::register(self::DESERT_PLAINS, new DesertPlainsBiome());
                self::register(self::ROOFED_PLAINS, new RoofedPlainsBiome());
                self::register(self::SNOW_PLAINS, new SnowPlainsBiome());
                self::register(self::BIRCH_PLAINS, new BirchPlainsBiome());
        }
