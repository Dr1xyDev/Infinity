...
class CreativeItems{
	...
	const ITEMS = [
		self::CATEGORY_BUILDING => [
			...
			["id" => Item::SANDSTONE],
			["id" => Item::SANDSTONE, "meta" => Sandstone::CHISELED], 
			["id" => Item::SANDSTONE, "meta" => Sandstone::SMOOTH],
			["id" => Item::RED_SANDSTONE],
			["id" => Item::RED_SANDSTONE, "meta" => Sandstone::CHISELED], 
