...
class RakLibInterface implements ServerInstance, AdvancedSourceInterface{
        ...
        public function closeSession($identifier, $reason){
                if(isset($this->players[$identifier])){
                        ...
                        if($anti !== null){
                                $anti->onSessionClose($player->getAddress());
                        }
        ...
        public function openSession($identifier, $address, $port, $clientID){
                ...
                $anti = $this->server->getAntiDDoS();
                if($anti !== null && !$anti->onSessionOpen($address)){
                        
                        $this->interface->closeSession($identifier, "Connection blocked by AntiDDoS");
                        return;
                }
        ...
        public function sendAntiDDoSConfig(string $serializedConfig){
                $this->interface->sendOption("antiddos", $serializedConfig);
        }
